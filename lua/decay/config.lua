...
M.highlights_base = function(colors, opts)
	return {
		...
		Variable = { fg = colors.brightgreen },
		String = { fg = colors.brightyellow },
		Character = { fg = colors.brightblue },
		Constant = { fg = colors.brightgreen },
		Number = { fg = colors.red },
		Boolean = { fg = colors.magenta },
		Float = { fg = colors.magenta },
		Identifier = { fg = colors.brightgreen },
		...
		Keyword = { fg = colors.brightgreen, italic = opts.italics.code },
